...
let rec gctr_encrypt_recursive (icb:quad32) (plain:list quad32 { 256 * length plain < nat32_max }) 
...
let gctr_encrypt (icb:quad32) (plain:list quad32 { 256 * length plain < nat32_max }) (alg:algorithm) (key:aes_key alg) =
