...
let cipher (alg:algorithm) (input:quad32) (round_keys:seq quad32{length round_keys == (nr alg) + 1}) : quad32 =
...
let aes_encrypt (alg:algorithm) (key:aes_key alg) (input:seqn 16 nat8) : seqn 16 nat8 =
  let key_LE = seq_nat8_to_seq_nat32_LE key in
