...
val addr_of: #a:Type0 -> #rel:preorder a -> mref a rel -> Tot nat

val is_mm: #a:Type0 -> #rel:preorder a -> mref a rel -> Tot bool
...
val addr_unused_in: nat -> heap -> bool

val unused_in: #a:Type0 -> #rel:preorder a -> mref a rel -> heap -> bool
