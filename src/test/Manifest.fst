...
(* fix the definitions later *)
let is_known_verified_entryponat6464 (faddr:nat64) (u:umemlayout) = true
let is_known_untrusted_entryponat6464 (faddr:nat64) (u:umemlayout) = true
