...
[@plugin norm_attr "opaque_to_smt"]
let upd (#a:Type0) (m:map16 a) (n:int) (v:a) : map16 a =
  upd16 m n v

let get (#a:Type0) (m:map16 a) (n:int) : a =
  sel m n

[@norm_attr]
let eta16 (#a:Type0) (m:map16 a) : map16 a =
...
[@norm_attr "opaque_to_smt"]
let eta (#a:Type0) (m:map16 a) : map16 a =
  eta16 m

val lemma_self (#a:Type0) (m:map16 a) (n:int) (v:a) : Lemma
  (requires 0 <= n /\ n < 16)
  (ensures sel (upd m n v) n == v)
  [SMTPat (sel (upd m n v) n)]

val lemma_other (#a:Type0) (m:map16 a) (n1 n2:int) (v:a) : Lemma
  (requires 0 <= n1 /\ n1 < 16 /\ 0 <= n2 /\ n2 < 16 /\ n1 =!= n2)
  (ensures sel (upd m n1 v) n2 == sel m n2)
  [SMTPat (sel (upd m n1 v) n2)]

val lemma_equal (#a:Type0) (m1 m2:map16 a) : Lemma
  (requires (forall (i:int).{:pattern (sel m1 i) \/ (sel m2 i)} 0 <= i /\ i < 16 ==> sel m1 i == sel m2 i))
  (ensures m1 == m2)

val lemma_eta16 (#a:Type0) (m:map16 a) : Lemma
  (ensures eta16 m == m)

val lemma_eta (#a:Type0) (m:map16 a) : Lemma
  (ensures eta m == m)
  [SMTPat (eta m)]
