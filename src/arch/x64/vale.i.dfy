...
lemma va_lemma_ifElse(ifb:obool, ct:code, cf:code, s:va_state, r:va_state) returns(cond:bool, s':va_state)
    ...
    requires x86_ValidState(s);
    requires va_is_src_operand_uint32(ifb.o1, s) && ValidSourceOperand(to_state(s), 32, ifb.o1);
    requires va_is_src_operand_uint32(ifb.o2, s) && ValidSourceOperand(to_state(s), 32, ifb.o2);
