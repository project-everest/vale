...
type va_value_mem_operanduint64 = uint64
type va_operand_mem_operanduint64 = va_mem_operand

predicate va_is_src_mem_operanduint64(o:opr, s:va_state)
{
    o.OConst? || (o.OReg? && !o.r.X86Xmm?) || (o.OHeap? && Valid64BitSourceOperand(to_state(s), o))
}

function va_eval_mem_operanduint64(s:va_state, o:opr):uint64
    requires va_is_src_mem_operanduint64(o, s)
{
    eval_op64(to_state(s), o)
}

function method va_op_mem_operand_reg64(r:x86reg):opr { OReg(r) }
function method va_op_mem_operanduint64_reg64(r:x86reg):opr { OReg(r) }
function method va_coerce_operand_to_mem_operand(o:opr):opr { o }
function method va_const_mem_operand(x:uint64):opr { OConst(x) }
function method va_const_mem_operanduint64(x:uint64):opr { OConst(x) }
