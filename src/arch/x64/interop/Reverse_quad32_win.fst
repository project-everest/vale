...
let ghost_reverse_bytes_quad32_buffer_win b stack_b h0 =
  ...
  let s1, f1 = va_lemma_reverse_bytes_quad32_buffer_win (va_code_reverse_bytes_quad32_buffer_win ()) s0 stack_b b  in
  ...
  // Ensures that va_code_reverse_bytes_quad32_buffer_win is actually Vale code, and that s1 is the result of executing this code
  assert (va_ensure_total (va_code_reverse_bytes_quad32_buffer_win ()) s0 s1 f1);
