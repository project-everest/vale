...
(h_b:buffer128) (hash_b:buffer128) (input_b:buffer128) (offset:nat64)  =
   ((va_require_total va_b0 (va_code_ghash_incremental_one_block_buffer_win ()) va_s0) /\
    ...
    (buffer_readable (va_get_mem va_s0) input_b) /\ (buffer_length stack_b) >= 9 /\
    (valid_stack_slots (va_get_mem va_s0) (va_get_reg Rsp va_s0) stack_b 4) /\ (va_get_reg Rcx
    ...
    (va_get_reg R9 va_s0) == offset /\ (buffer_length input_b) >= offset + 1 /\ (buffer_length h_b)
    >= 1 /\ (buffer_length hash_b) >= 1)
...
(h_b:buffer128) (hash_b:buffer128) (input_b:buffer128) (offset:nat64)  =
   ((va_ensure_total va_b0 va_s0 va_sM va_fM) /\ (va_get_ok va_sM)
    ...
    (loc_buffer stack_b)) (va_get_mem va_s0) (va_get_mem va_sM)) /\ (let old_hash = (buffer128_read
    hash_b 0 (va_get_mem va_s0)) in let new_hash = (buffer128_read hash_b 0 (va_get_mem va_sM)) in
    let h_q = (buffer128_read h_b 0 (va_get_mem va_s0)) in let input_quad = (buffer128_read input_b
    offset (va_get_mem va_s0)) in new_hash == (ghash_incremental h_q old_hash (Seq.create 1
    input_quad))) /\ (va_state_eq va_sM (va_update_mem va_sM (va_update_flags va_sM (va_update_xmm
    15 va_sM (va_update_xmm 14 va_sM (va_update_xmm 13 va_sM (va_update_xmm 12 va_sM (va_update_xmm
    11 va_sM (va_update_xmm 10 va_sM (va_update_xmm 9 va_sM (va_update_xmm 8 va_sM (va_update_xmm 7
