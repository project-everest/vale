...
assume val addrs: addr_map//The initial registers and xmms
...
let gcm_load_xor_store_buffer plain_b mask_b cipher_b offset num_blocks key iv  =
  let h0 = get() in
  st_put h0 (fun h -> pre_cond h plain_b mask_b cipher_b (UInt64.v offset) num_blocks key iv ) (ghost_gcm_load_xor_store_buffer plain_b mask_b cipher_b (UInt64.v offset) num_blocks key iv )
