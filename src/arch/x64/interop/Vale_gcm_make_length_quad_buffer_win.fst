...
(plain_num_bytes:nat64) (auth_num_bytes:nat64) (b:buffer128)  =
  ((va_require_total va_b0 (va_code_gcm_make_length_quad_buffer_win ()) va_s0) /\
    ...
    (va_get_mem va_s0) stack_b) /\ (buffer_readable (va_get_mem va_s0) b) /\ (buffer_length
    stack_b) >= 4 /\ (valid_stack_slots (va_get_mem va_s0) (va_get_reg Rsp va_s0) stack_b 0) /\
    (va_get_reg Rcx va_s0) == plain_num_bytes /\ (va_get_reg Rdx va_s0) == auth_num_bytes /\
    (va_get_reg R8 va_s0) == (buffer_addr b (va_get_mem va_s0)) /\ (buffer_length b) == 1 /\ 8
    `op_Multiply` plain_num_bytes < pow2_32 /\ 8 `op_Multiply` auth_num_bytes < pow2_32)
...
va_pre va_b0 va_s0 stack_b plain_num_bytes auth_num_bytes b /\
   ((va_ensure_total va_b0 va_s0 va_sM va_fM) /\ (va_get_ok va_sM)
    ...
    (va_get_mem va_sM)) /\ (buffer128_read b 0 (va_get_mem va_sM)) == (reverse_bytes_quad32 (Mkfour
    (8 `op_Multiply` plain_num_bytes) 0 (8 `op_Multiply` auth_num_bytes) 0)) /\ (va_state_eq va_sM
