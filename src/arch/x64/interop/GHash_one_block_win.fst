...
let implies_pre (h0:HS.mem) (h_b:b8) (hash_b:b8) (input_b:b8) (offset:nat64)  (stack_b:b8) : Lemma
  ...
  (ensures (
B.length stack_b == 72 /\ live h0 stack_b /\ buf_disjoint_from stack_b [h_b;hash_b;input_b] /\ (  let buffers = stack_b::h_b::hash_b::input_b::[] in
...
let implies_post (va_s0:va_state) (va_sM:va_state) (va_fM:va_fuel) (h_b:b8) (hash_b:b8) (input_b:b8) (offset:nat64)  (stack_b:b8) : Lemma
...
val ghost_ghash_incremental_one_block_buffer_win: h_b:b8 -> hash_b:b8 -> input_b:b8 -> offset:nat64 ->  stack_b:b8 -> (h0:HS.mem{pre_cond h0 h_b hash_b input_b offset /\ B.length stack_b == 72 /\ live h0 stack_b /\ buf_disjoint_from stack_b [h_b;hash_b;input_b]}) -> GTot (h1:HS.mem{partial_post_cond h0 h1 h_b hash_b input_b offset /\ M.modifies (M.loc_union (M.loc_buffer hash_b) (M.loc_buffer stack_b)) h0 h1})
...
let ghash_incremental_one_block_buffer_win h_b hash_b input_b offset  =
  ...
  let h0 = get() in
  st_put h0 (fun h -> pre_cond h h_b hash_b input_b (UInt64.v offset) /\ B.length stack_b == 72 /\ live h stack_b /\ buf_disjoint_from stack_b [h_b;hash_b;input_b]) (ghost_ghash_incremental_one_block_buffer_win h_b hash_b input_b (UInt64.v offset) stack_b);
  pop_frame()
