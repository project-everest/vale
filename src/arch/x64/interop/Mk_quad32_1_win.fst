...
val ghost_mk_quad32_lo0_be_1_buffer_win: b:b8 ->  stack_b:b8 -> (h0:HS.mem{pre_cond h0 b /\ B.length stack_b == 16 /\ live h0 stack_b /\ locs_disjoint [stack_b;b]}) -> GTot (h1:HS.mem{post_cond h0 h1 b })
...
let mk_quad32_lo0_be_1_buffer_win b  =
  ...
  let h0 = get() in
  st_put h0 (fun h -> pre_cond h b /\ B.length stack_b == 16 /\ live h stack_b /\ locs_disjoint [stack_b;b]) (ghost_mk_quad32_lo0_be_1_buffer_win b stack_b);
  pop_frame()
