...
(plain_b:buffer128) (plain_num_bytes:nat64) (auth_b:buffer128) (auth_num_bytes:nat64) (iv_b:buffer128) (keys_b:buffer128) (cipher_b:buffer128) (tag_b:buffer128)  = True

let va_post (va_b0:va_code) (va_s0:va_state) (va_sM:va_state) (va_fM:va_fuel)
  (plain_b:buffer128) (plain_num_bytes:nat64) (auth_b:buffer128) (auth_num_bytes:nat64) (iv_b:buffer128) (keys_b:buffer128) (cipher_b:buffer128) (tag_b:buffer128)  =
...
val va_lemma_gcmencrypt(va_b0:va_code) (va_s0:va_state)
  (plain_b:buffer128) (plain_num_bytes:nat64) (auth_b:buffer128) (auth_num_bytes:nat64) (iv_b:buffer128) (keys_b:buffer128) (cipher_b:buffer128) (tag_b:buffer128) : Ghost ((va_sM:va_state) * (va_fM:va_fuel))
  (requires va_pre va_b0 va_s0 plain_b plain_num_bytes auth_b auth_num_bytes iv_b keys_b cipher_b tag_b )
  (ensures (fun (va_sM, va_fM) -> va_post va_b0 va_s0 va_sM va_fM plain_b plain_num_bytes auth_b auth_num_bytes iv_b keys_b cipher_b tag_b ))
