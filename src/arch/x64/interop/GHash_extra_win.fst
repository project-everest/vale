...
let implies_pre (h0:HS.mem) (in_b:b8) (hash_b:b8) (h_b:b8) (num_bytes:nat64) (orig_hash:Ghost.erased (quad32))  (stack_b:b8) : Lemma
  ...
  (ensures (
B.length stack_b == 72 /\ live h0 stack_b /\ buf_disjoint_from stack_b [in_b;hash_b;h_b] /\ (  let buffers = stack_b::in_b::hash_b::h_b::[] in
...
let implies_post (va_s0:va_state) (va_sM:va_state) (va_fM:va_fuel) (in_b:b8) (hash_b:b8) (h_b:b8) (num_bytes:nat64) (orig_hash:Ghost.erased (quad32))  (stack_b:b8) : Lemma
...
let ghash_incremental_extra_stdcall_win in_b hash_b h_b num_bytes orig_hash  =
  ...
  let h0 = get() in
  st_put h0 (fun h -> pre_cond h in_b hash_b h_b (UInt64.v num_bytes) orig_hash /\ B.length stack_b == 72 /\ live h stack_b /\ buf_disjoint_from stack_b [in_b;hash_b;h_b]) (ghost_ghash_incremental_extra_stdcall_win in_b hash_b h_b (UInt64.v num_bytes) orig_hash stack_b);
  pop_frame()
