module Vale_gctr_bytes_extra_buffer
...
val va_code_gctr_bytes_extra_buffer: unit -> va_code
let va_code_gctr_bytes_extra_buffer () = va_code_gctr_bytes_extra_stdcall AES_128
...
(plain_b:buffer128) (num_bytes:nat32) (iv_old:(quad32)) (iv_b:buffer128) (key:(aes_key_LE AES_128)) (keys_b:buffer128) (cipher_b:buffer128)  =
   let alg = AES_128 in
   ((va_require_total va_b0 (va_code_gctr_bytes_extra_stdcall alg) va_s0) /\ (va_get_ok
    ...
    pow2_32 /\ 256 `op_Multiply` (bytes_to_quad_size num_bytes) < pow2_32 /\ (alg = AES_128 || alg
    = AES_256) /\ (buffer_length keys_b) == (nr alg) + 1 /\ (buffer_as_seq (va_get_mem va_s0)
    keys_b) == (key_to_round_keys_LE alg key) /\ (let num_blocks = num_bytes `op_Division` 16 in
    ...
    num_bytes /\ (gctr_partial alg num_blocks (buffer128_as_seq (va_get_mem va_s0) plain_b)
    (buffer128_as_seq (va_get_mem va_s0) cipher_b) key iv_old) /\ (buffer128_read iv_b 0
    (va_get_mem va_s0)) == (inc32 iv_old num_blocks)))
...
let va_post (va_b0:va_code) (va_s0:va_state) (va_sM:va_state) (va_fM:va_fuel)
  (plain_b:buffer128) (num_bytes:nat32) (iv_old:(quad32)) (iv_b:buffer128) (key:(aes_key_LE AES_128)) (keys_b:buffer128) (cipher_b:buffer128)  =
    ...
    num_bytes) in cipher == (gctr_encrypt_LE iv_old (make_gctr_plain_LE plain) alg key) /\ (let
...
val va_lemma_gctr_bytes_extra_buffer(va_b0:va_code) (va_s0:va_state)
  (plain_b:buffer128) (num_bytes:nat32) (iv_old:(quad32)) (iv_b:buffer128) (key:(aes_key_LE AES_128)) (keys_b:buffer128) (cipher_b:buffer128) : Ghost ((va_sM:va_state) * (va_fM:va_fuel))
  (requires va_pre va_b0 va_s0 plain_b num_bytes iv_old iv_b key keys_b cipher_b )
  (ensures (fun (va_sM, va_fM) -> va_post va_b0 va_s0 va_sM va_fM plain_b num_bytes iv_old iv_b key keys_b cipher_b ))

let va_lemma_gctr_bytes_extra_buffer va_b0 va_s0 plain_b num_bytes iv_old iv_b key keys_b cipher_b = 
  va_lemma_gctr_bytes_extra_stdcall va_b0 va_s0 AES_128 plain_b num_bytes iv_old iv_b key keys_b cipher_b
