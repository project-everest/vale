module Vale_zero_quad32_buffer
...
val va_code_zero_quad32_buffer: unit -> va_code
let va_code_zero_quad32_buffer = va_code_zero_quad32_buffer
...
(b:buffer128)  =
   ((va_require_total va_b0 (va_code_zero_quad32_buffer ()) va_s0) /\ (va_get_ok va_s0) /\
    (buffer_readable (va_get_mem va_s0) b) /\ (buffer_length b) == 1 /\ (va_get_reg Rdi va_s0) ==
    (buffer_addr b (va_get_mem va_s0)))
...
let va_post (va_b0:va_code) (va_s0:va_state) (va_sM:va_state) (va_fM:va_fuel)
  ...
  ((va_ensure_total va_b0 va_s0 va_sM va_fM) /\ (va_get_ok va_sM)
    /\ (buffer_readable (va_get_mem va_sM) b) /\ (buffer_length b) == 1 /\ (va_get_reg Rdi va_sM)
    == (buffer_addr b (va_get_mem va_sM)) /\ (va_get_reg Rbx va_sM) == (va_get_reg Rbx va_s0) /\
    (va_get_reg Rbp va_sM) == (va_get_reg Rbp va_s0) /\ (va_get_reg R12 va_sM) == (va_get_reg R12
    ...
    (modifies_buffer128 b (va_get_mem va_s0) (va_get_mem va_sM)) /\ (buffer128_read b 0 (va_get_mem
    va_sM)) == (Mkfour 0 0 0 0) /\ (va_state_eq va_sM (va_update_mem va_sM (va_update_flags va_sM
...
val va_lemma_zero_quad32_buffer(va_b0:va_code) (va_s0:va_state)
...
let va_lemma_zero_quad32_buffer = va_lemma_zero_quad32_buffer
