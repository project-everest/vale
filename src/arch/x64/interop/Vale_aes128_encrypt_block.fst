...
val va_code_aes128_encrypt_block: unit -> va_code
let va_code_aes128_encrypt_block () = va_code_AESEncryptBlockStdcall is_win AES_128
...
let vale_pre (va_b0:va_code) (va_s0:va_state) (win:bool) (alg:algorithm)
 ...
 (va_require_total va_b0 (va_code_AESEncryptBlockStdcall win alg) va_s0) /\ (va_get_ok
    ...
    (va_get_mem va_s0) input_ptr input_buffer 1) /\ (validSrcAddrs128 (va_get_mem va_s0) output_ptr
    output_buffer 1) /\ (validSrcAddrs128 (va_get_mem va_s0) expanded_key_ptr keys_buffer ((nr alg)
    + 1)) /\ (forall (i:int) . (0 <= i && i < (nr alg) + 1) ==> (buffer128_read keys_buffer i
    (va_get_mem va_s0)) == (index (key_to_round_keys_LE alg key) i)))  
...
let vale_post (va_b0:va_code) (va_s0:va_state) (win:bool) (alg:algorithm)
  ...
  (keys_buffer:buffer128) (va_sM:va_state) (va_fM:va_fuel) =
    ...
    output_buffer 0 (va_get_mem va_sM)) == (aes_encrypt_LE alg key input)) /\ (va_state_eq va_sM
    (va_update_flags va_sM (va_update_xmm 2 va_sM (va_update_xmm 0 va_sM (va_update_mem va_sM
    (va_update_reg r8 va_sM (va_update_ok va_sM va_s0)))))))
...
val va_lemma_aes128_encrypt_block(va_b0:va_code) (va_s0:va_state)
  (output_b:buffer128) (input_b:buffer128) (key:(aes_key_LE AES_128)) (keys_b:buffer128) : Ghost ((va_sM:va_state) * (va_fM:va_fuel))
  (requires va_pre va_b0 va_s0 output_b input_b key keys_b )
  (ensures (fun (va_sM, va_fM) -> va_post va_b0 va_s0 va_sM va_fM output_b input_b key keys_b ))

let va_lemma_aes128_encrypt_block va_b0 va_s0 output_b input_b key keys_b =
