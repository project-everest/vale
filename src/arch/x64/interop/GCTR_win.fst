...
let implies_pre (h0:HS.mem) (plain_b:b8) (num_bytes:nat64) (iv_old:Ghost.erased (quad32)) (iv_b:b8) (key:Ghost.erased (aes_key_LE AES_128)) (keys_b:b8) (cipher_b:b8)  (stack_b:b8) : Lemma
  ...
  (ensures (
B.length stack_b == 48 /\ live h0 stack_b /\ buf_disjoint_from stack_b [plain_b;iv_b;keys_b;cipher_b] /\ (  let buffers = stack_b::plain_b::iv_b::keys_b::cipher_b::[] in
