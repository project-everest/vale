module Vale_ghash_incremental_extra_stdcall_win
...
val va_code_ghash_incremental_extra_stdcall_win: unit -> va_code
let va_code_ghash_incremental_extra_stdcall_win = va_code_ghash_incremental_extra_stdcall_win
...
(in_b:buffer128) (hash_b:buffer128) (h_b:buffer128) (num_bytes:nat64) (orig_hash:(quad32))  =
  ((va_require_total va_b0 (va_code_ghash_incremental_extra_stdcall_win ()) va_s0) /\
    (va_get_ok va_s0) /\ (buffer_readable (va_get_mem va_s0) in_b) /\ (buffer_readable (va_get_mem
    va_s0) hash_b) /\ (buffer_readable (va_get_mem va_s0) h_b) /\ (valid_taint_buf128 in_b
    (va_get_mem va_s0) (va_get_memTaint va_s0) Secret) /\ (valid_taint_buf128 hash_b (va_get_mem
    va_s0) (va_get_memTaint va_s0) Secret) /\ (valid_taint_buf128 h_b (va_get_mem va_s0)
    (va_get_memTaint va_s0) Secret) /\ (locs_disjoint [(loc_buffer stack_b); (loc_buffer in_b);
...
(in_b:buffer128) (hash_b:buffer128) (h_b:buffer128) (num_bytes:nat64) (orig_hash:(quad32))  =
  ((va_ensure_total va_b0 va_s0 va_sM va_fM) /\ (va_get_ok va_sM)
    /\ (buffer_readable (va_get_mem va_sM) in_b) /\ (buffer_readable (va_get_mem va_sM) hash_b) /\
    (buffer_readable (va_get_mem va_sM) h_b) /\ (valid_taint_buf128 in_b (va_get_mem va_sM)
    (va_get_memTaint va_sM) Secret) /\ (valid_taint_buf128 hash_b (va_get_mem va_sM)
    (va_get_memTaint va_sM) Secret) /\ (valid_taint_buf128 h_b (va_get_mem va_sM) (va_get_memTaint
    va_sM) Secret) /\ (va_get_reg Rbx va_sM) == (va_get_reg Rbx va_s0) /\ (va_get_reg Rbp va_sM) ==
    (va_get_reg Rbp va_s0) /\ (va_get_reg Rdi va_sM) == (va_get_reg Rdi va_s0) /\ (va_get_reg Rsi
    va_sM) == (va_get_reg Rsi va_s0) /\ (va_get_reg Rsp va_sM) == (va_get_reg Rsp va_s0) /\
    ...
    (va_get_reg R15 va_s0) /\ (va_get_xmm 6 va_sM) == (va_get_xmm 6 va_s0) /\ (va_get_xmm 7 va_sM)
    == (va_get_xmm 7 va_s0) /\ (va_get_xmm 8 va_sM) == (va_get_xmm 8 va_s0) /\ (va_get_xmm 9 va_sM)
    == (va_get_xmm 9 va_s0) /\ (va_get_xmm 10 va_sM) == (va_get_xmm 10 va_s0) /\ (va_get_xmm 11
    va_sM) == (va_get_xmm 11 va_s0) /\ (va_get_xmm 12 va_sM) == (va_get_xmm 12 va_s0) /\
    (va_get_xmm 13 va_sM) == (va_get_xmm 13 va_s0) /\ (va_get_xmm 14 va_sM) == (va_get_xmm 14
    va_s0) /\ (va_get_xmm 15 va_sM) == (va_get_xmm 15 va_s0) /\ (modifies_mem (loc_union
    (loc_buffer hash_b) (loc_buffer stack_b)) (va_get_mem va_s0) (va_get_mem va_sM)) /\
    (buffer_readable (va_get_mem va_sM) in_b) /\ (buffer_readable (va_get_mem va_sM) hash_b) /\
    (buffer_readable (va_get_mem va_sM) h_b) /\ (let h_val = (buffer128_read h_b 0 (va_get_mem
    va_sM)) in let new_hash = (buffer128_read hash_b 0 (va_get_mem va_sM)) in let input_bytes =
...
(in_b:buffer128) (hash_b:buffer128) (h_b:buffer128) (num_bytes:nat64) (orig_hash:(quad32)) : Ghost ((va_sM:va_state) * (va_fM:va_fuel))
  ...
  (ensures (fun (va_sM, va_fM) -> va_post va_b0 va_s0 va_sM va_fM stack_b in_b hash_b h_b num_bytes orig_hash ))

let va_lemma_ghash_incremental_extra_stdcall_win = va_lemma_ghash_incremental_extra_stdcall_win
