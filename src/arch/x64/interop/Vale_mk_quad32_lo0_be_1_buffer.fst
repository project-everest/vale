module Vale_mk_quad32_lo0_be_1_buffer
...
val va_code_mk_quad32_lo0_be_1_buffer: unit -> va_code
let va_code_mk_quad32_lo0_be_1_buffer = va_code_mk_quad32_lo0_be_1_buffer
...
(b:buffer128)  =
((va_require_total va_b0 (va_code_mk_quad32_lo0_be_1_buffer ()) va_s0) /\ (va_get_ok
    va_s0) /\ (buffer_readable (va_get_mem va_s0) b) /\ (buffer_length b) == 1 /\ (va_get_reg Rdi
    va_s0) == (buffer_addr b (va_get_mem va_s0)))
...
let va_post (va_b0:va_code) (va_s0:va_state) (va_sM:va_state) (va_fM:va_fuel)
  ...
  ((va_ensure_total va_b0 va_s0 va_sM va_fM) /\ (va_get_ok va_sM)
    ...
    va_sM)) /\ (let old_b = (buffer128_read b 0 (va_get_mem va_s0)) in let new_b = (buffer128_read
    b 0 (va_get_mem va_sM)) in new_b == (Mkfour 1 old_b.lo1 old_b.hi2 old_b.hi3)) /\ (va_state_eq
...
val va_lemma_mk_quad32_lo0_be_1_buffer(va_b0:va_code) (va_s0:va_state)
...
let va_lemma_mk_quad32_lo0_be_1_buffer = va_lemma_mk_quad32_lo0_be_1_buffer
