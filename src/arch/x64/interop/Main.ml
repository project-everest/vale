...
let ghash_extra = ("ghash_incremental_extra_stdcall_win", [
  ...
  ("orig_hash", TGhost "quad32")], Stk (Prims.parse_int "4"))
*)
(*
...
*)
(*
let inc32 = ("inc32_buffer_win", [("iv_b", TBuffer TUInt128)], Stk (Prims.parse_int "0"))
*)

(* 
let quad32_xor = ("quad32_xor_buffer_win", [("src1", TBuffer TUInt128);
