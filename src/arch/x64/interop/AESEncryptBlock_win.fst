...
let aes128_encrypt_block_win output_b input_b key keys_b  =
  ...
  let h0 = get() in
  st_put h0 (fun h -> pre_cond h output_b input_b key keys_b /\ B.length stack_b == 32 /\ live h stack_b /\ buf_disjoint_from stack_b [output_b;input_b;keys_b]) (ghost_aes128_encrypt_block_win output_b input_b key keys_b stack_b);
  pop_frame()
