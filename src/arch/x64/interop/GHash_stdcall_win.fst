...
let implies_pre (h0:HS.mem) (h_b:b8) (hash_b:b8) (input_b:b8) (num_bytes:nat64)  (stack_b:b8) : Lemma
  ...
  (ensures (
B.length stack_b == 80 /\ live h0 stack_b /\ buf_disjoint_from stack_b [h_b;hash_b;input_b] /\ (  let buffers = stack_b::h_b::hash_b::input_b::[] in
...
let implies_post (va_s0:va_state) (va_sM:va_state) (va_fM:va_fuel) (h_b:b8) (hash_b:b8) (input_b:b8) (num_bytes:nat64)  (stack_b:b8) : Lemma
...
let ghash_incremental_bytes_stdcall_win h_b hash_b input_b num_bytes  =
  ...
  let h0 = get() in
  st_put h0 (fun h -> pre_cond h h_b hash_b input_b (UInt64.v num_bytes) /\ B.length stack_b == 80 /\ live h stack_b /\ buf_disjoint_from stack_b [h_b;hash_b;input_b]) (ghost_ghash_incremental_bytes_stdcall_win h_b hash_b input_b (UInt64.v num_bytes) stack_b);
  pop_frame()
