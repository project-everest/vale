...
let (add : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.add (Prims.parse_int "31") (v a) (v b)) 
let (sub : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.sub (Prims.parse_int "31") (v a) (v b)) 
let (mul : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.mul (Prims.parse_int "31") (v a) (v b)) 
let (div : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.div (Prims.parse_int "31") (v a) (v b)) 
let (rem : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.mod_ (Prims.parse_int "31") (v a) (v b)) 
let (logand : t -> t -> t) =
  fun x  ->
    fun y  -> Mk (FStar_Int.logand (Prims.parse_int "31") (v x) (v y))
  
let (logxor : t -> t -> t) =
  fun x  ->
    fun y  -> Mk (FStar_Int.logxor (Prims.parse_int "31") (v x) (v y))
  
let (logor : t -> t -> t) =
  fun x  -> fun y  -> Mk (FStar_Int.logor (Prims.parse_int "31") (v x) (v y)) 
let (lognot : t -> t) =
  fun x  -> Mk (FStar_Int.lognot (Prims.parse_int "31") (v x)) 
let (shift_right : t -> FStar_UInt32.t -> t) =
  fun a  ->
    fun s  ->
      Mk
        (FStar_Int.shift_right (Prims.parse_int "31") (v a)
           (FStar_UInt32.v s))
...
let (shift_left : t -> FStar_UInt32.t -> t) =
  fun a  ->
    fun s  ->
      Mk
        (FStar_Int.shift_left (Prims.parse_int "31") (v a) (FStar_UInt32.v s))
  
let (eq : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.eq (Prims.parse_int "31") (v a) (v b) 
let (gt : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.gt (Prims.parse_int "31") (v a) (v b) 
let (gte : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.gte (Prims.parse_int "31") (v a) (v b) 
let (lt : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.lt (Prims.parse_int "31") (v a) (v b) 
let (lte : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.lte (Prims.parse_int "31") (v a) (v b) 
