...
let vale_pre (va_b0:va_code) (va_s0:va_state) (win:bool) (alg:algorithm)
  ...
  ((va_require_total va_b0 (va_code_AESEncryptBlockStdcall_BE win alg) va_s0) /\
    ...
    input_buffer 1) /\ (validSrcAddrs128 (va_get_mem va_s0) output_ptr output_buffer 1) /\
    (validSrcAddrs128 (va_get_mem va_s0) expanded_key_ptr keys_buffer ((nr alg) + 1)) /\ (forall
