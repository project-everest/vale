...
((va_require_total va_b0 (va_code_zero_quad32_buffer_win ()) va_s0) /\ (va_get_ok
    va_s0) /\ (locs_disjoint [(loc_buffer stack_b); (loc_buffer b)]) /\ (buffer_readable
    ...
    (va_get_reg Rcx va_s0) == (buffer_addr b (va_get_mem va_s0)) /\ (buffer_length b) == 1)
...
let va_post (va_b0:va_code) (va_s0:va_state) (va_sM:va_state) (va_fM:va_fuel) (stack_b:buffer64)
  (b:buffer128)  =
   ((va_ensure_total va_b0 va_s0 va_sM va_fM) /\ (va_get_ok va_sM)
    ...
    (va_get_mem va_sM)) /\ (buffer128_read b 0 (va_get_mem va_sM)) == (Mkfour 0 0 0 0) /\
