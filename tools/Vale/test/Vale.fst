...
(*
 * Aseem says, "what are the access qualifiers on Semantics and this interface?"
 *)
...
let va_const_shift_amt (n:nat{normalize (n < pow2 64)}) :va_shift_amt = OConst (FStar.UInt64.uint_to_t n)
...
let va_is_dst_register (r:reg) (s:va_state) = true
...
(* Evaluation *)
let va_eval_operand_uint64     (s:va_state) (o:va_operand)     :int = FStar.UInt64.v (eval_operand o s)
let va_eval_dst_operand_uint64 (s:va_state) (o:va_dst_operand) :int = FStar.UInt64.v (eval_operand o s)
let va_eval_shift_amt_uint64   (s:va_state) (o:va_shift_amt)   :int = FStar.UInt64.v (eval_operand o s)
let va_eval_cmp_uint64         (s:va_state) (r:va_cmp)         :int = FStar.UInt64.v (eval_operand r s)
let va_eval_register_uint64    (s:va_state) (r:va_register)    :int = FStar.UInt64.v (eval_reg r s)
