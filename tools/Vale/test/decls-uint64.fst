...
irreducible val va_lemma_AddLea64 : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_AddLea64 dst src1 src2) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_operand_uint64 src1 va_s0) /\
    (va_is_src_operand_uint64 src2 va_s0) /\ 
    (va_get_ok va_s0) /\ 
    v (va_eval_operand_uint64 va_s0 src1) + v (va_eval_operand_uint64 va_s0 src2) < nat64_max))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN)
    /\ (va_get_ok va_sM)
    /\ (va_eval_dst_operand_uint64 va_sM dst) == 
            (va_eval_operand_uint64 va_s0 src1) +%^ (va_eval_operand_uint64 va_s0 src2) 
    /\ (va_state_eq va_sM (va_update_ok va_sM (va_update_dst_operand dst va_sM va_s0))))))
...
irreducible val va_lemma_Adc64Wrap : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_Adc64Wrap dst src) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_operand_uint64 src va_s0) /\ 
    (va_get_ok va_s0)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN) /\ 
    (va_get_ok va_sM) /\ 
    v (va_eval_dst_operand_uint64 va_sM dst)
      == (v (va_eval_dst_operand_uint64 va_s0 dst) + 
          v (va_eval_operand_uint64 va_s0 src) + 
         (if (cf (va_get_flags va_s0)) then 1 else 0)) 
         % nat64_max /\ 
    (cf (va_get_flags va_sM)) 
    == ((v (va_eval_dst_operand_uint64 va_s0 dst) + 
         v (va_eval_operand_uint64 va_s0 src)) + 
         (if (cf (va_get_flags va_s0)) then 1 else 0) >= nat64_max) /\ 
    (va_state_eq va_sM (va_update_flags va_sM (va_update_ok va_sM (va_update_dst_operand dst va_sM va_s0)))))))
...
irreducible val va_lemma_Sub64 : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires ((
    va_require va_b0 (va_code_Sub64 dst src) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_operand_uint64 src va_s0) /\ 
    (va_get_ok va_s0) /\ 
    0 <= v (va_eval_dst_operand_uint64 va_s0 dst) - v (va_eval_operand_uint64 va_s0 src)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN) /\
    (va_get_ok va_sM) /\ 
    (va_eval_dst_operand_uint64 va_sM dst) 
...
irreducible val va_lemma_Sub64Wrap : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_Sub64Wrap dst src) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_operand_uint64 src va_s0) /\ 
    (va_get_ok va_s0)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
...
irreducible val va_lemma_Mul64Wrap : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_Mul64Wrap src) va_s0 va_sN) /\ 
    (va_is_src_operand_uint64 src va_s0) /\ 
    (va_get_ok va_s0)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN) /\
    (va_get_ok va_sM) /\ 
    (va_get_reg Rax va_sM) == ((va_get_reg Rax va_s0) *%^ (va_eval_operand_uint64 va_s0 src)) /\
    (va_get_reg Rdx va_sM) == ((va_get_reg Rax va_s0) */^ (va_eval_operand_uint64 va_s0 src)) /\
    (va_state_eq va_sM (va_update_reg Rdx va_sM (va_update_reg Rax va_sM (va_update_flags va_sM (va_update_ok va_sM va_s0))))))))
...
irreducible val va_lemma_IMul64Wrap : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_IMul64Wrap dst src) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_operand_uint64 src va_s0) /\ 
    (va_get_ok va_s0)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN) /\
    (va_get_ok va_sM) /\ 
    (va_eval_dst_operand_uint64 va_sM dst) == ((va_eval_dst_operand_uint64 va_s0 dst) *%^ (va_eval_operand_uint64 va_s0 src)) /\
    (va_state_eq va_sM (va_update_flags va_sM (va_update_ok va_sM (va_update_dst_operand dst va_sM va_s0)))))))
...
irreducible val va_lemma_Xor64 : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_Xor64 dst src) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_operand_uint64 src va_s0) /\ 
    (va_get_ok va_s0)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN) /\
    (va_get_ok va_sM) /\
    (va_eval_dst_operand_uint64 va_sM dst) == (logxor64 (va_eval_dst_operand_uint64 va_s0 dst) (va_eval_operand_uint64 va_s0 src)) /\ 
    (va_state_eq va_sM (va_update_flags va_sM (va_update_ok va_sM (va_update_dst_operand dst va_sM va_s0)))))))
...
irreducible val va_lemma_And64 : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  dst:va_dst_operand -> src:va_operand
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_And64 dst src) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_operand_uint64 src va_s0) /\ 
    (va_get_ok va_s0)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN) /\ 
    (va_get_ok va_sM) /\ 
    (va_eval_dst_operand_uint64 va_sM dst) == (logand64 (va_eval_dst_operand_uint64 va_s0 dst) (va_eval_operand_uint64 va_s0 src)) /\ 
    (va_state_eq va_sM (va_update_flags va_sM (va_update_ok va_sM (va_update_dst_operand dst va_sM va_s0)))))))
irreducible let va_lemma_And64 va_b0 va_s0 va_sN dst src =
  ();
  let (va_old_s:va_state) = va_s0 in
  let (va_sM, (va_cM:va_code), va_bM) = (va_lemma_block va_b0 va_s0 va_sN) in
  (va_bM, va_sM)
...
irreducible val va_lemma_Shl64 : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_Shl64 dst amt) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_shift_amt_uint64 amt va_s0) /\
    (va_get_ok va_s0)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN) /\
    (va_get_ok va_sM) /\ 
    (va_eval_dst_operand_uint64 va_sM dst) == (shift_left64 (va_eval_dst_operand_uint64 va_s0 dst) (va_eval_shift_amt_uint64 va_s0 amt)) /\ 
    (va_state_eq va_sM (va_update_flags va_sM (va_update_ok va_sM (va_update_dst_operand dst va_sM va_s0)))))))
...
irreducible val va_lemma_Shr64 : va_b0:va_codes -> va_s0:va_state -> va_sN:va_state ->
  ...
  -> Ghost ((va_bM:va_codes) * (va_sM:va_state))
  (requires (
    (va_require va_b0 (va_code_Shr64 dst amt) va_s0 va_sN) /\
    (va_is_dst_dst_operand_uint64 dst va_s0) /\ 
    (va_is_src_shift_amt_uint64 amt va_s0) /\
    (va_get_ok va_s0)))
  (ensures (fun ((va_bM:va_codes), (va_sM:va_state)) -> (
    (va_ensure va_b0 va_bM va_s0 va_sM va_sN) /\
    (va_get_ok va_sM) /\ 
    (va_eval_dst_operand_uint64 va_sM dst) == (shift_right64 (va_eval_dst_operand_uint64 va_s0 dst) (va_eval_shift_amt_uint64 va_s0 amt)) /\ 
    (va_state_eq va_sM (va_update_flags va_sM (va_update_ok va_sM (va_update_dst_operand dst va_sM va_s0)))))))
